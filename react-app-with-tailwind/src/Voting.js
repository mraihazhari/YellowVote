...
function Voting () {
  ...
  return(
    ...
    <label className="py-px block text-base text-center bg-blue-700 font-medium text-yellow-300">Pick your choice by checking one of the checkboxes, and then click submit to save it.</label>
    ...
    <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
      {candidates.data?.map((choice) => (
        <div key={choice.id} className="group relative">
          ...
          <div className="flex py-3 w-max gap-4">
              <Checkbox color="blue" />
          </div>
        </div>
